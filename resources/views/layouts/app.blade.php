...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center">
            <p style="margin-top: 10px;"> &copy;<script>document.write(new Date().getFullYear());</script> - Copyright LAMTHAI | Website Created <i class="fa fa-heart" aria-hidden="true"></i> By <b>Lam Thai</b></p>
        </div>
    </div>
</div>

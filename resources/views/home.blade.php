...
<!--extend dùng để gọi ra phần header,hero và footer của website--> 
@extends('layouts.layout1')
<!--extend dùng để gọi ra phần header,hero và footer của website--> 

@section('title', 'WebSite_clothes - Home') <!--title là dòng khi mở website thành công n sẽ hiện trên thanh tap của cửa sổ window-->
<!--gọi ra banner của website -->
@section('hero')

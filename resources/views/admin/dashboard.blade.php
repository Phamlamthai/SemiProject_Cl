                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-bottom:1px;">
                        <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                            <h4 class="text-left text-uppercase"><b>Product</b></h4>
                            <div class="row vertical-center-box vertical-center-box-tablet">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                            <h4 class="text-left text-uppercase"><b>Turnover</b></h4>
                            <div class="row vertical-center-box vertical-center-box-tablet">
                                <div class="text-left col-xs-3 mar-bot-15">
            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="caption pro-sl-hd">
                                        <span class="caption-subject text-uppercase"><b>Statistics of products sold</b></span>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="white-box analytics-info-cs mg-b-10 res-mg-t-30">
                        <h3 class="box-title">Total hits</h3>
                    ...
                    <div class="white-box analytics-info-cs mg-b-10">
                        <h3 class="box-title">Total page hit</h3>
                        <ul class="list-inline two-part-sp">
                            <li>
                    ...
                    <div class="white-box analytics-info-cs mg-b-10">
                        <h3 class="box-title">Customer Only Hits</h3>
                        <ul class="list-inline two-part-sp">
                            <li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="white-box tranffic-als-inner">
                        <h3 class="box-title"><small class="pull-right m-t-10 text-success"><i class="fa fa-sort-asc"></i> 18% last month</small> website traffic</h3>
                        <div class="stats-row">
                            <div class="stat-item">
                                <h6>Total</h6>
                                <b>80.40%</b></div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="white-box tranffic-als-inner res-mg-t-30">
                        <h3 class="box-title"><small class="pull-right m-t-10 text-danger"><i class="fa fa-sort-desc"></i> 18% last month</small>website traffic</h3>
                        <div class="stats-row">
                            <div class="stat-item">
                                <h6>Total</h6>
                                <b>80.40%</b></div>
                    ...
                    <div class="product-sales-chart">
                        <div class="portlet-title">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="caption pro-sl-hd">
                                        <span class="caption-subject text-uppercase"><b>Order Statistics</b></span>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="actions graph-rp">

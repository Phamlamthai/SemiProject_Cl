    ...
    <div class="container pt-5">
        ...
        <div class="node-news-full-body">
            <div class="node-news-full-body-container">
                ...
                <p><strong>Giám đốc :&nbsp;HHHHHHHHHHH.</strong>
                </p>
                ...
                <p>Trải qua một thời gian hoạt động, chúng tôi đã
                    đạt được một số thành tựu : không ngừng mở rộng
                    quan hệ với các đối tác, doanh số liên tục tăng,
                    sản phẩm đa dạng, đội ngũ cán bộ nhân viên và cơ
                    cấu tổ chức hoạt động ngày càng chuyên nghiệp,
                    hệ thống khách hàng liên tục tăng.&nbsp;
                    <br>
                    Mong muốn của Công Ty khách hàng luôn là bạn là
                    đồng nghiệp cùng chia sẻ, ủng hộ và phát triển.
                    Với suy nghĩ đó, chúng tôi luôn luôn cố gắng
                    mang hết kinh nghiệm cùng với sự nhiệt tình,
                    năng động, sáng tạo và trí tuệ của toàn bộ đội
